...
var documentedColumns = map[string][]string{
	...
	"spaces":         {"source_id", "key", "name", "kind", "homepage_id", "watermark"},
	"items_fts":      {"title", "labels", "body_text", "comments_text", "cjk_bigram"},
	"deleted_items":  {"key", "source_id", "deleted_at"},
	"saved_views":    {"id", "name", "config", "created_at", "updated_at"},
	"source_queries": {"id", "source_id", "external_id", "name", "query_text", "config", "favourite", "owner", "applied", "unsupported", "updated_at"},
	...
	"sync_state": {"source_id", "watermark", "version", "last_full_sync_at", "last_error", "schema_version",
		...
		"scope_hash", "reconcile_at", "reconcile_upstream_keys", "reconcile_missing_fetched",
		"reconcile_gone_deleted"},
