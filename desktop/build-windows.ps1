...
#   Missing runtime (from wails v3.0.0-beta.22 source, not launched here):
#   webviewloader returns "no webview2 found"; Chromium.Embed waits at most
#   60s for the controller (60s in every beta cached locally: 15, 17, 22),
#   then Chromium.errorCallback logs and os.Exit(1).
